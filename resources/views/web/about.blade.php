...
@section('content')
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(web/images/2.jpg);">

      <div class="slider-item" style="background-image: url(web/images/2.jpg);">
